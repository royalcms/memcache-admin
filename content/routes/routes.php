...
RC_Route::addRoute(['GET', 'HEAD'], '/liveness', 'Ecjia\Kernel\Http\Controllers\HealthCheckController@liveness');
RC_Route::addRoute(['GET', 'HEAD'], '/readiness', 'Ecjia\Kernel\Http\Controllers\HealthCheckController@readiness');
